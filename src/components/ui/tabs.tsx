...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-card p-1 text-muted-foreground border border-border",
      className
    )}
    {...props}
  />
